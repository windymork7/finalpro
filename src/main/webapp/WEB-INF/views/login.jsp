            ...
            <form>
               <fieldset>
                  <div class="form-group">
                     <label for="exampleInputEmail1"><b>이메일</b></label> <input
                        type="email" class="form-control" id="exampleInputEmail1"
                        aria-describedby="emailHelp">
                  </div>
                  <div class="form-group">
                     <label for="exampleInputPassword1"><b>비밀번호</b></label> <input
                        type="password" class="form-control" id="exampleInputPassword1">
                  </div>
                  <div class="form-group">
                     <label for="exampleInputPassword2"><b>비밀번호 확인</b></label> <input
                  ...
                  <div class="form-group">
                     <label for="nickname"><b>닉네임</b></label> <input type="text"
