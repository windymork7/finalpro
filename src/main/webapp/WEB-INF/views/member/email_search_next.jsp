				...
				<!-- 해당 email 데이터값 뿌리기 -->
					...
					<div class="form-group">
						<div class="custom-control col-sm-6" id="c_left">
							<button type="button" class="btn btn-primary btn-lg btn-block" onclick="location.href='/loginForm.me'">로그인하기</button>
						</div>
						<div class="custom-control col-sm-6" id="c_right">
							<button type="button" class="btn btn-secondary btn-lg btn-block" onclick="location.href='/passSearchFirst.me'">비밀번호 찾기</button>
						</div>
					</div>
